...
WEEKS = {
    ...
    7:  dict(theme="Smaller, Faster, Looped", flag=("robot",),
             robot="Smaller but still strong driving base + new Technician delivery (Kyle · Lindsey · Kei); grand tree delivery to loop the cave waterfall (Cheryl · Lola)",
             project="Identify the target audience; log failures and fixes in the notebook"),
