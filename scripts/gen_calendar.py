...
WEEKS = {
    ...
    8:  dict(theme="Three Projects", flag=("robot",),
             robot="P1 Young forest + nest + hollow tree (Cheryl · Lola) · P2 Cave waterfall (Kyle · Lindsey · Kei) · P3 Operator (Kei) — cut anything under 40%",
             project="Improve the lacewing habitat design on feedback"),
