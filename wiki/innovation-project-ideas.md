...
> **The kids choose, not the adults.** This is raw material for the Week 3 vote (Aug 16), nothing more. The rubric scores *"explored multiple ideas and clearly explains reasoning for selection"* — so **keep the rejected ones and write down why**. A shortlist the team argued over is worth more at judging than a perfect idea handed to them. See [[judging-and-awards]].

## Why San Diego Is A Gift Here

San Diego County has **more federally endangered species than any other county in the continental United States**. The team lives inside a biodiversity hotspot, which means:

- Real habitat is 10–20 minutes away, not a field-trip-of-a-lifetime
- Repeat visits are possible — the team can go back and check on things
- Local experts exist in quantity
- The problem is genuinely theirs, which judges can hear in how kids talk about it

That last one matters more than it sounds. A team that has stood in the place they are talking about sounds different from one that read about the Amazon.
...
| Test | Why |
|------|-----|
| Can we **visit** it? | Fieldwork beats a web search on every Explore row |
| Is there an **expert** we can actually reach? | Weeks 3–4 need a real interview |
| Can we **build** something? | A prototype is required |
| Is there a **real user**? | The Implement rows ask who it helps |
| Can a 4th grader explain it in 60 seconds? | Five minutes goes fast |
