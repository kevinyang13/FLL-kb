...
Nine main game models (individually numbered 1-9), plus a combined 1+2 instruction set, three extension models (E1, E2, E3), and an element overview parts guide. (source: season-materials page)
...
- [Season materials hub](https://education.lego.com/en-us/first-lego-league/season-materials/)
